export const FormatsData: import('../../../sim/dex-species').ModdedSpeciesDataTable = {
	// susko: { inherit: true, tier: "OU", isNonstandard: 'Custom' },
	// krackgar: { inherit: true, tier: "OU", isNonstandard: 'Custom' },
	// hornititaneetle: { inherit: true, tier: "OU", isNonstandard: 'Custom' },
	// vintini: { inherit: true, tier: "OU", isNonstandard: 'Custom' },
	// zangursed: { inherit: true, tier: "OU", isNonstandard: 'Custom' },
	// oengas: { inherit: true, tier: "OU", isNonstandard: 'Custom' },
