export const Pokedex: import('../sim/dex-species').SpeciesDataTable = {
	...
	dragonite: {
		...
		abilities: {0: "Prism Scales", 1: "Dragon's Maw", H: "Multiscale"},
		heightm: 2.2,
		weightkg: 210,
		color: "Brown",
		prevo: "Dragonair",
	...
	mew: {
		...
		gender: "N",
		baseStats: {hp: 100, atk: 100, def: 100, spa: 100, spd: 100, spe: 100},
		abilities: {0: "Imposter", 1: "Mystic Power", H: "Magic Guard"},
		heightm: 0.4,
		weightkg: 4,
		color: "Pink",
		tags: ["Mythical"],
	...
	xatu: {
		...
		name: "Xatu",
		types: ["Psychic", "Flying"],
		baseStats: {hp: 82, atk: 80, def: 80, spa: 115, spd: 80, spe: 106},
		abilities: {0: "Inversion", 1: "Unnerve", H: "Magic Bounce"},
		heightm: 1.5,
		weightkg: 15,
		color: "Green",
		prevo: "Natu",
	...
	ampharosmega: {
		...
		abilities: {0: "Mold Breaker", 1:"Dazzling", H:"Overwhelm"},
		heightm: 1.4,
		weightkg: 61.5,
		color: "Yellow",
		eggGroups: ["Monster", "Field"],
	...
	raikou: {
		...
		abilities: {0: "Drizzle",1: "Ground Shock", H: "Transistor",},
		heightm: 1.9,
		weightkg: 178,
		color: "Yellow",
		tags: ["Sub-Legendary"],
	...
	entei: {
		...
		abilities: {0: "Flaming Soul", 1: "Drought", H: "Inner Focus"},
		heightm: 2.1,
		weightkg: 198,
		color: "Brown",
		tags: ["Sub-Legendary"],
	...
	suicune: {
		...
		abilities: {0: "Prism Scales", 1: "North Wind", H: "Drizzle"},
		heightm: 2,
		weightkg: 187,
		color: "Blue",
		tags: ["Sub-Legendary"],
	...
	wailord: {
		...
		abilities: {0: "Analytic", 1: "Stamina", H: "Drizzle"},
		heightm: 14.5,
		weightkg: 398,
		color: "Blue",
		prevo: "Wailmer",
	...
	banette: {
		...
		name: "Banette",
		types: ["Ghost", "Normal"],
		baseStats: {hp: 84, atk: 125, def: 85, spa: 63, spd: 83, spe: 98},
		abilities: {0: "Tag", 1: "Frisk", H: "Cursed Body"},
		heightm: 1.1,
		weightkg: 12.5,
		color: "Black",
		prevo: "Shuppet",
	...
	metagross: {
		...
		abilities: {0: "Lead Coat", H: "Light Metal"},
		heightm: 1.6,
		weightkg: 550,
		color: "Blue",
		prevo: "Metang",
	...
	jirachi: {
		...
		gender: "N",
		baseStats: {hp: 100, atk: 100, def: 100, spa: 100, spd: 100, spe: 100},
		abilities: {0: "Doombringer", 1: "Regenerator", H: "Wishmaker"},
		heightm: 0.3,
		weightkg: 1.1,
		color: "Yellow",
		tags: ["Mythical"],
	...
	regigigas: {
		...
		types: ["Normal"],
		gender: "N",
		baseStats: {hp: 130, atk: 160, def: 120, spa: 70, spd: 120, spe: 60},
	...
	reuniclus: {
		...
		abilities: {0: "Twist Dimension", 1: "Neuroforce", H: "Regenerator"},
		heightm: 1,
		weightkg: 20.1,
		color: "Green",
		prevo: "Duosion",
	...
	thundurus: {
		...
		gender: "M",
		baseStats: {hp: 79, atk: 115, def: 70, spa: 125, spd: 80, spe: 111},
		abilities: {0: "Transistor", H: "Raging Storm", 1:"Thundercall"},
		heightm: 1.5,
		weightkg: 61,
		color: "Blue",
		tags: ["Sub-Legendary"],
	...
	toedscruel: {
		...
		types: ["Ground", "Grass"],
		baseStats: {hp: 80, atk: 70, def: 65, spa: 80, spd: 120, spe: 100},
		abilities: {0: "Mycelium Might", 1:"Arena Trap"},
		heightm: 1.9,
		weightkg: 58,
		color: "Black",
		prevo: "Toedscool",
	...
	rabsca: {
		...
		abilities: {0: "Twist Dimension", H: "Telepathy"},
		heightm: 0.3,
		weightkg: 3.5,
		color: "Green",
		prevo: "Rellor",
	...
	tinkaton: {
		...
		abilities: {0: "Mold Breaker", 1: "Readied Action", H: "Opportunist"},
		heightm: 0.7,
		weightkg: 112.8,
		color: "Pink",
		prevo: "Tinkatuff",
	...
	gholdengo: {
		...
		abilities: {0: "Good as Gold", 1: "Sharing is Caring", H: "Prankster"},
		heightm: 1.2,
		weightkg: 30,
		color: "Yellow",
		prevo: "Gimmighoul",
	...
	koraidon: {
		...
		abilities: {0: "Rock Head", 1: "Sun Basking"},
		heightm: 2.5,
		weightkg: 303,
		color: "Red",
		tags: ["Restricted Legendary"],
	...
	miraidon: {
		...
		abilities: {0: "Thundercall", 1: "Terminal Velocity"},
		heightm: 3.5,
		weightkg: 240,
		color: "Blue",
		tags: ["Restricted Legendary"],
	...
	houndoomredux: {
		...
		weightkg: 0,
		evoLevel: 0,
		evoItem: "houndoominite_r",
		evos: ["Houndoom Mega Redux"],
	...
	garchompredux: {
		...
		weightkg: 0,
		evoLevel: 0,
		evoItem: "garchompite_r",
		evos: ["Garchomp Mega Redux"],
		prevo: "Gabite Redux",
	},
	garchompmegaredux: {
	...
	skarmoryredux: {
		...
		weightkg: 0,
		evoLevel: 0,
		evoItem: "skarmorite_r",
		evos: ["Skarmory Mega Redux"],
	},
	skarmorymegaredux: {
	...
	machampredux: {
		...
		weightkg: 0,
		evoLevel: 0,
		evoItem: "machampite_r",
		evos: ["Machamp Mega Redux"],
		prevo: "Machoke Redux",
	},
	machampmegaredux: {
	...
	beedrillredux: {
		...
		weightkg: 0,
		evoLevel: 0,
		evoItem: "beedrillite_r",
		evos: ["Beedrill Mega Redux"],
		prevo: "Kakuna Redux",
	},
	beedrillmegaredux: {
	...
	tyranitarredux: {
		...
		weightkg: 0,
		evoLevel: 0,
		evoItem: "tyranitarite_r",
		evos: ["Tyranitar Mega Redux"],
		prevo: "Pupitar Redux",
	},
	pupitarredux: {
		name: "Pupitar-Redux",
	...
	scizorredux: {
		name: "Scizor-Redux",
		num: 2577,
		types: ["Poison", "Steel", "Dragon"],
		abilities: {
			0: "Mind Crunch", H: "Chrome Coat", 
		},
		baseStats: {
			hp: 70,
			atk: 50,
	...
	kingdramegay: {
		...
		num: 230,
		types: ["Water","Dragon"],
		abilities: {0: "Swift Swim", 1: "Sniper", H: "Riptide"},
		baseStats: {
			hp: 75,
			atk: 95,
			def: 95,
	...
	wormadamsandycloak: {
		...
		num: 413,
		types: ["Bug","Ground"],
		abilities: {0: "Anticipation", 1: "Rock Head", H: "Overcoat"},
		baseStats: {
			hp: 80,
			atk: 99,
			def: 105,
	...
	wormadamtrashcloak: {
		...
		num: 413,
		types: ["Bug","Steel"],
		abilities: {0: "Anticipation", 1: "Weak Armor", H: "Overcoat"},
		baseStats: {
			hp: 80,
			atk: 69,
			def: 105,
	...
	shelloseastsea: {
		...
		num: 422,
		types: ["Water"],
		abilities: {0: "Shell Armor", 1: "Storm Drain", H: "Regenerator"},
		baseStats: {
			hp: 76,
			atk: 48,
			def: 48,
	...
	darmanitanzenmode: {
		...
		num: 555,
		types: ["Fire","Psychic"],
		abilities: {0: "Sheer Force", 1: "Psychic Mind", H: "Zen Mode"},
		baseStats: {
			hp: 105,
			atk: 30,
			def: 105,
	...
	deerlingsummer: {
		...
		num: 585,
		types: ["Normal","Grass"],
		abilities: {0: "Chlorophyll", H: "Serene Grace"},
		baseStats: {
			hp: 60,
			atk: 60,
			def: 50,
	...
	genesectdousedrive: {
		...
		num: 649,
		types: ["Bug","Steel"],
		abilities: {0: "Download", 1: "Fatal Precision", H: "Sighting System"},
		baseStats: {
			hp: 71,
			atk: 120,
			def: 95,
	...
	greninjabattlebond: {
		...
		num: 658,
		types: ["Water","Dark"],
		abilities: {0: "Battle Bond", 1: "Battle Bond", H: "Battle Bond"},
		baseStats: {
			hp: 72,
			atk: 95,
			def: 67,
	...
	florgesyellowflower: {
		...
		num: 671,
		types: ["Fairy"],
		abilities: {0: "Harvest", 1: "Misty Surge", H: "Fairy Aura"},
		baseStats: {
			hp: 78,
			atk: 65,
			def: 68,
	...
	meowsticfemale: {
		...
		num: 678,
		types: ["Psychic"],
		abilities: {0: "Infiltrator", 1: "Competitive", H: "Sage Power"},
		baseStats: {
			hp: 74,
			atk: 48,
			def: 76,
	...
	xerneasactive: {
		...
		num: 716,
		types: ["Fairy"],
		abilities: {0: "Pixilate", 1: "Competitive", H: "Self Sufficient"},
		baseStats: {
			hp: 126,
			atk: 131,
			def: 95,
	...
	zygarde50powerconstruct: {
		...
		num: 718,
		types: ["Dragon","Ground"],
		abilities: {0: "Aura Break", 1: "Regenerator", H: "Power Construct"},
		baseStats: {
			hp: 108,
			atk: 100,
			def: 121,
	...
	zygarde10powerconstruct: {
		...
		num: 718,
		types: ["Dragon","Ground"],
		abilities: {0: "Aura Break", 1: "Hyper Aggressive", H: "Power Construct"},
		baseStats: {
			hp: 54,
			atk: 100,
			def: 71,
	...
	rockruffowntempo: {
		...
		num: 744,
		types: ["Rock"],
		abilities: {0: "Own Tempo", 1: "Own Tempo", H: "Own Tempo"},
		baseStats: {
			hp: 45,
			atk: 65,
			def: 40,
	...
	miniormeteororange: {
		...
		num: 774,
		types: ["Rock","Flying"],
		abilities: {0: "Shields Down", 1: "Shields Down", H: "Shields Down"},
		baseStats: {
			hp: 60,
			atk: 60,
			def: 100,
	...
	magearnaoriginalcolor: {
		...
		num: 801,
		types: ["Steel","Fairy"],
		abilities: {0: "Steelworker", 1: "Pixilate", H: "Mirror Armor"},
		baseStats: {
			hp: 80,
			atk: 95,
			def: 115,
	...
	vivillonpolar: {
		...
		num: 666,
		types: ["Bug","Flying"],
		abilities: {0: "Swarm", 1: "Tinted Lens", H: "Effect Spore"},
		baseStats: {
			hp: 80,
			atk: 52,
			def: 50,
	...
	sinisteaantique: {
		...
		num: 854,
		types: ["Ghost"],
		abilities: {0: "Weak Armor", 1: "Weak Armor", H: "Cursed Body"},
		baseStats: {
			hp: 40,
			atk: 45,
			def: 45,
	...
	alcremierubycream: {
		...
		num: 869,
		types: ["Fairy"],
		abilities: {0: "Sweet Veil", 1: "Sweet Veil", H: "Aroma Veil"},
		baseStats: {
			hp: 65,
			atk: 60,
			def: 75,
	...
	eiscuenoiceface: {
		...
		num: 875,
		types: ["Ice"],
		abilities: {0: "Ice Face", 1: "Ice Face", H: "Ice Face"},
		baseStats: {
			hp: 75,
			atk: 80,
			def: 70,
	...
	zaciancrownedsword: {
		...
		num: 888,
		types: ["Fairy","Steel"],
		abilities: {0: "Intrepid Sword", 1: "Intrepid Sword", H: "Intrepid Sword"},
		baseStats: {
			hp: 92,
			atk: 170,
			def: 115,
	...
	zamazentacrownedshield: {
		...
		num: 889,
		types: ["Fighting","Steel"],
		abilities: {0: "Relentless Shield", 1: "Dauntless Shield", H: "Dauntless Shield"},
		baseStats: {
			hp: 92,
			atk: 110,
			def: 155,
	...
	urshifurapidstrikestyle: {
		...
		num: 892,
		types: ["Fighting","Water"],
		abilities: {0: "Unseen Fist", 1: "Unseen Fist", H: "Unseen Fist"},
		baseStats: {
			hp: 100,
			atk: 130,
			def: 100,
	...
	calyrexicerider: {
		...
		num: 898,
		types: ["Psychic","Ice"],
		abilities: {0: "As One", 1: "As One", H: "As One"},
		baseStats: {
			hp: 100,
			atk: 165,
			def: 150,
	...
	dewleon: {
		...
		num: -1001253,
		types: ["Ice","Normal"],
		abilities: {0: "Prismatic Fur", 1: "Prismatic Fur", H: "Prismatic Fur"},
		baseStats: {
			hp: 90,
			atk: 90,
			def: 70,
	...
	dipplin: {
		...
		num: 1011,
		types: ["Grass","Dragon"],
		abilities: {0: "Draco Morale", 1: "Regenerator", H: "Aroma Veil"},
		baseStats: {
			hp: 80,
			atk: 80,
			def: 110,
	...
	poltchageist: {
		...
		num: 1012,
		types: ["Grass","Ghost"],
		abilities: {0: "Ill Will", 1: "Self Sufficient", H: "Water Absorb"},
		baseStats: {
			hp: 40,
			atk: 45,
			def: 45,
	...
	sinistcha: {
		...
		num: 1013,
		types: ["Grass","Ghost"],
		abilities: {0: "Ill Will", 1: "Self Sufficient", H: "Hospitality"},
		baseStats: {
			hp: 71,
			atk: 60,
			def: 106,
	...
	okidogi: {
		...
		num: 1014,
		types: ["Poison","Fighting"],
		abilities: {0: "Hyper Aggressive", 1: "No Guard", H: "Guts"},
		baseStats: {
			hp: 88,
			atk: 128,
			def: 115,
	...
	munkidori: {
		...
		num: 1015,
		types: ["Poison","Psychic"],
		abilities: {0: "Merciless", 1: "Forewarn", H: "Prankster"},
		baseStats: {
			hp: 88,
			atk: 75,
			def: 66,
	...
	fezandipiti: {
		...
		num: 1016,
		types: ["Poison","Fairy"],
		abilities: {0: "Corrosion", 1: "Dazzling", H: "Technician"},
		baseStats: {
			hp: 82,
			atk: 90,
			def: 75,
	...
	ogerpon: {
		...
		num: 1017,
		types: ["Grass"],
		abilities: {0: "Prankster", 1: "Raw Wood", H: "Defiant"},
		baseStats: {
			hp: 80,
			atk: 120,
			def: 84,
	...
	hydrapple: {
		...
		num: 1019,
		types: ["Grass","Dragon"],
		abilities: {0: "Self Sufficient", 1: "Regenerator", H: "Supersweet Syrup"},
		baseStats: {
			hp: 106,
			atk: 80,
			def: 110,
	...
	arachtres: {
		...
		num: 1029,
		types: ["Bug","Poison"],
		abilities: {0: "Spider Lair", 1: "Sniper", H: "Exploit Weakness"},
		baseStats: {
			hp: 100,
			atk: 130,
			def: 80,
	...
	flairgrance: {
		...
		num: 1030,
		types: ["Fairy","Poison"],
		abilities: {0: "Aroma Veil", 1: "Lingering Aroma", H: "Fairy Aura"},
		baseStats: {
			hp: 121,
			atk: 72,
			def: 89,
	...
	arashinne: {
		...
		num: 1032,
		types: ["Electric","Fairy"],
		abilities: {0: "Power Spot", 1: "Pretty Privilege", H: "Ground Shock"},
		baseStats: {
			hp: 93,
			atk: 58,
			def: 57,
	...
	dreadnaut: {
		...
		num: 1033,
		types: ["Ghost","Grass"],
		abilities: {0: "Steely Spirit", 1: "Juggernaut", H: "Battle Armor"},
		baseStats: {
			hp: 100,
			atk: 131,
			def: 140,
	...
	boarlock: {
		...
		num: 1034,
		types: ["Psychic"],
		abilities: {0: "Headstrong", 1: "Gluttony", H: "Magic Bounce"},
		baseStats: {
			hp: 120,
			atk: 65,
			def: 65,
	...
	heliosunny: {
		...
		num: 1035,
		types: ["Electric","Fire"],
		abilities: {0: "Generator", 1: "Drought", H: "Power Spot"},
		baseStats: {
			hp: 70,
			atk: 61,
			def: 52,
	...
	sopranice: {
		...
		num: 1036,
		types: ["Ice","Psychic"],
		abilities: {0: "Snow Song", 1: "Reverberate", H: "Psychic Surge"},
		baseStats: {
			hp: 75,
			atk: 50,
			def: 75,
	...
	beefender: {
		...
		num: 1037,
		types: ["Bug","Flying"],
		abilities: {0: "Beast Boost", 1: "Aerodynamics", H: "Tag"},
		baseStats: {
			hp: 60,
			atk: 124,
			def: 60,
	...
	salazarus: {
		...
		num: 1038,
		types: ["Poison","Fire"],
		abilities: {0: "Supreme Overlord", 1: "Big Pecks", H: "Hustle"},
		baseStats: {
			hp: 85,
			atk: 104,
			def: 85,
	...
	gooschase: {
		...
		num: 1040,
		types: ["Normal"],
		abilities: {0: "Restraining Order", 1: "Intimidate", H: "Scare"},
		baseStats: {
			hp: 98,
			atk: 120,
			def: 80,
	...
	lepastry: {
		...
		num: 1039,
		types: ["Fairy","Fighting"],
		abilities: {0: "Gladiator", 1: "Gooey", H: "Pastel Veil"},
		baseStats: {
			hp: 112,
			atk: 82,
			def: 99,
	...
	gyaradeath: {
		...
		num: 1041,
		types: ["Ghost"],
		abilities: {0: "Scare", 1: "Moxie", H: "Greater Spirit"},
		baseStats: {
			hp: 95,
			atk: 110,
			def: 79,
	...
	tortemple: {
		...
		num: 1042,
		types: ["Fire"],
		abilities: {0: "Stamina", 1: "White Smoke", H: "Mountaineer"},
		baseStats: {
			hp: 90,
			atk: 100,
			def: 160,
	...
	brontonana: {
		...
		num: 1043,
		types: ["Grass","Dragon"],
		abilities: {0: "Ripen", 1: "Grass Pelt", H: "Dragon's Maw"},
		baseStats: {
			hp: 123,
			atk: 88,
			def: 82,
	...
	dredwood: {
		...
		num: 1044,
		types: ["Ghost","Grass"],
		abilities: {0: "Tough Claws", 1: "Low Visibility", H: "Grassy Surge"},
		baseStats: {
			hp: 111,
			atk: 130,
			def: 106,
	...
	popcorm: {
		...
		num: 1047,
		types: ["Grass","Fire"],
		abilities: {0: "Unburden", 1: "Solar Power", H: "Puffy"},
		baseStats: {
			hp: 95,
			atk: 110,
			def: 90,
	...
	blizzardmaw: {
		...
		num: 1048,
		types: ["Ice","Dark"],
		abilities: {0: "Scare", 1: "Growing Tooth", H: "Cryo Proficiency"},
		baseStats: {
			hp: 115,
			atk: 133,
			def: 101,
	...
	lumbersloth: {
		...
		num: 1049,
		types: ["Fire","Grass"],
		abilities: {0: "Overcoat", 1: "Forest Rage", H: "Flash Fire"},
		baseStats: {
			hp: 109,
			atk: 135,
			def: 91,
	...
	ironcarapace: {
		...
		num: 1050,
		types: ["Electric","Steel"],
		abilities: {0: "Coil Up", 1: "Speed Force", H: "Short Circuit"},
		baseStats: {
			hp: 92,
			atk: 64,
			def: 98,
	...
	magmenous: {
		...
		num: 1051,
		types: ["Poison","Fire"],
		abilities: {0: "Violent Rush", 1: "Neurotoxin", H: "Shell Armor"},
		baseStats: {
			hp: 80,
			atk: 120,
			def: 125,
	...
	kaiosea: {
		...
		num: 1052,
		types: ["Water","Flying"],
		abilities: {0: "Lightning Rod", 1: "Multiscale", H: "Draconize"},
		baseStats: {
			hp: 90,
			atk: 122,
			def: 70,
	...
	shyduck: {
		...
		num: 1054,
		types: ["Dark"],
		abilities: {0: "Anger Point", 1: "Low Blow", H: "Soul Linker"},
		baseStats: {
			hp: 90,
			atk: 86,
			def: 86,
	...
	slyduck: {
		...
		num: 1053,
		types: ["Dark"],
		abilities: {0: "Fearmonger", 1: "Fatal Precision", H: "Ambush"},
		baseStats: {
			hp: 80,
			atk: 156,
			def: 70,
	...
	marbeep: {
		...
		num: 1055,
		types: ["Bug"],
		abilities: {0: "Honey Gather", 1: "Gooey", H: "Compound Eyes"},
		baseStats: {
			hp: 70,
			atk: 40,
			def: 45,
	...
	bariong: {
		...
		num: 1058,
		types: ["Ice","Dragon"],
		abilities: {0: "Multiscale", 1: "Clear Body", H: "Dragon's Maw"},
		baseStats: {
			hp: 100,
			atk: 100,
			def: 85,
	...
	phanfernal: {
		...
		num: 1060,
		types: ["Fire","Grass"],
		abilities: {0: "Speed Boost", 1: "Scare", H: "Soul Eater"},
		baseStats: {
			hp: 95,
			atk: 78,
			def: 142,
	...
	skulberus: {
		...
		num: 1061,
		types: ["Dark"],
		abilities: {0: "Moxie", 1: "Stygian Rush", H: "Strong Jaw"},
		baseStats: {
			hp: 100,
			atk: 135,
			def: 90,
	...
	velozel: {
		...
		num: 1062,
		types: ["Flying"],
		abilities: {0: "Impulse", 1: "Momentum", H: "Air Blower"},
		baseStats: {
			hp: 95,
			atk: 80,
			def: 70,
	...
	bubbleo: {
		...
		num: 1068,
		types: ["Water","Poison"],
		abilities: {0: "Violent Rush", 1: "Accelerate", H: "Scare"},
		baseStats: {
			hp: 72,
			atk: 85,
			def: 69,
	...
	hydroar: {
		...
		num: 1069,
		types: ["Water","Poison"],
		abilities: {0: "Violent Rush", 1: "Accelerate", H: "Terrify"},
		baseStats: {
			hp: 100,
			atk: 125,
			def: 85,
	...
	granitun: {
		...
		num: 1120,
		types: ["Grass","Dragon"],
		abilities: {0: "Unaware", 1: "Looter", H: "Friend Guard"},
		baseStats: {
			hp: 110,
			atk: 100,
			def: 90,
	...
	fujiflap: {
		...
		num: 1121,
		types: ["Grass","Dragon"],
		abilities: {0: "Hustle", 1: "Aerodynamics", H: "Air Blower"},
		baseStats: {
			hp: 80,
			atk: 125,
			def: 85,
	...
	burmyeterna: {
		...
		num: 412,
		types: ["Bug","Poison"],
		abilities: {0: "Anticipation", 1: "Analytic", H: "Corrosion"},
		baseStats: {
			hp: 210,
			atk: 79,
			def: 205,
	...
	sagaracas: {
		...
		num: 1064,
		types: ["Grass"],
		abilities: {0: "Chlorophyll", 1: "Dune Terror", H: "Reservoir"},
		baseStats: {
			hp: 90,
			atk: 66,
			def: 92,
	...
	luminositeon: {
		...
		num: 1072,
		types: ["Water","Fairy"],
		abilities: {0: "Protean", 1: "Storm Drain", H: "Dazzling"},
		baseStats: {
			hp: 83,
			atk: 69,
			def: 76,
	...
	crawdauntless: {
		...
		num: 1075,
		types: ["Water","Dark"],
		abilities: {0: "Swift Swim", 1: "Dauntless Shield", H: "Adaptability"},
		baseStats: {
			hp: 86,
			atk: 160,
			def: 105,
	...
	scrafster: {
		...
		num: 1067,
		types: ["Dark", "Fighting"],
		abilities: {0: "Combat Specialist", 1: "Moxie", H: "Stygian Rush"},
		baseStats: {
			hp: 90,
			atk: 115,
			def: 115,
	...
	ironvoca: {
		...
		num: 1070,
		types: ["Steel","Normal"],
		abilities: {0: "Punk Rock", 1: "Pixie Power", H: "Tangling Hair"},
		baseStats: {
			hp: 94,
			atk: 56,
			def: 120,
	...
	morpekyll: {
		...
		num: 1119,
		types: ["Electric","Dark"],
		abilities: {0: "Gluttony", 1: "Unburden", H: "Pickup"},
		baseStats: {
			hp: 87,
			atk: 121,
			def: 78,
	...
	frostula: {
		...
		num: 1073,
		types: ["Ice","Bug"],
		abilities: {0: "Ice Body", 1: "Cryo Architect", H: "Spider Lair"},
		baseStats: {
			hp: 85,
			atk: 120,
			def: 132,
	...
	dududunsparce: {
		...
		num: 1065,
		types: ["Normal","Ground"],
		abilities: {0: "Mighty Horn", 1: "Tipping Point", H: "Unaware"},
		baseStats: {
			hp: 145,
			atk: 115,
			def: 80,
	...
	ogerponmega: {
		...
		num: 1017,
		types: ["Grass"],
		abilities: {0: "Embody Aspect", 1: "Embody Aspect", H: "Embody Aspect"},
		baseStats: {
			hp: 80,
			atk: 125,
			def: 104,
	...
	seerkat: {
		...
		num: 1122,
		types: ["Normal","Ground"],
		abilities: {0: "Stakeout", 1: "Anticipation", H: "Pretentious"},
		baseStats: {
			hp: 100,
			atk: 120,
			def: 79,
	...
	tentagrewl: {
		...
		num: 1076,
		types: ["Water","Poison"],
		abilities: {0: "Corrosion", 1: "Predator", H: "Headstrong"},
		baseStats: {
			hp: 100,
			atk: 80,
			def: 90,
	...
	cacjack: {
		...
		num: 1077,
		types: ["Grass","Dark"],
		abilities: {0: "Tipping Point", 1: "Prankster", H: "Soul Tap"},
		baseStats: {
			hp: 80,
			atk: 125,
			def: 80,
	...
	tyranjoula: {
		...
		num: 1078,
		types: ["Bug","Electric"],
		abilities: {0: "Merciless", 1: "Web Spinner", H: "Itchy Defense"},
		baseStats: {
			hp: 128,
			atk: 77,
			def: 96,
	...
	cragchungus: {
		...
		num: 1085,
		types: ["Rock","Ground"],
		abilities: {0: "Thick Skin", 1: "Keen Edge", H: "Pressure"},
		baseStats: {
			hp: 111,
			atk: 125,
			def: 119,
	...
	dedelibird: {
		...
		num: 1125,
		types: ["Ice","Flying"],
		abilities: {0: "Christmas Spirit", 1: "Cool Exit", H: "Friend Guard"},
		baseStats: {
			hp: 125,
			atk: 65,
			def: 60,
	...
	krampird: {
		...
		num: 1126,
		types: ["Ice"],
		abilities: {0: "Snow Cloak", 1: "Slush Rush", H: "Power Spot"},
		baseStats: {
			hp: 80,
			atk: 110,
			def: 70,
	...
	ironpalette: {
		...
		num: 1124,
		types: ["Normal","Psychic"],
		abilities: {0: "Protean", 1: "Analytic", H: "Artillery"},
		baseStats: {
			hp: 114,
			atk: 80,
			def: 60,
	...
	carbonix: {
		...
		num: 1127,
		types: ["Rock","Dragon"],
		abilities: {0: "Sand Stream", 1: "Stalwart", H: "Earth Eater"},
		baseStats: {
			hp: 75,
			atk: 55,
			def: 75,
	...
	wispywaspy: {
		...
		num: 1129,
		types: ["Bug","Ghost"],
		abilities: {0: "Shield Dust", 1: "Early Grave", H: "Surprise!"},
		baseStats: {
			hp: 50,
			atk: 20,
			def: 15,
	...
	ironscythe: {
		...
		num: 1089,
		types: ["Poison","Ghost"],
		abilities: {0: "Sweeping Edge", 1: "Chrome Coat", H: "Fatal Precision"},
		baseStats: {
			hp: 102,
			atk: 126,
			def: 68,
	...
	woolyworm: {
		...
		num: 1090,
		types: ["Grass","Bug"],
		abilities: {0: "Sharp Edges", 1: "Raw Wood", H: "Drought"},
		baseStats: {
			hp: 181,
			atk: 83,
			def: 61,
	...
	heracreus: {
		...
		num: 1091,
		types: ["Grass","Fairy"],
		abilities: {0: "Spike Armor", 1: "Serene Grace", H: "Poison Point"},
		baseStats: {
			hp: 75,
			atk: 100,
			def: 100,
	...
	grotom: {
		...
		num: 1128,
		types: ["Poison"],
		abilities: {0: "Scavenger", 1: "Neurotoxin", H: "Speed Force"},
		baseStats: {
			hp: 70,
			atk: 100,
			def: 87,
	...
	orchestot: {
		...
		num: 1092,
		types: ["Normal","Flying"],
		abilities: {0: "Musical Notes", 1: "Prankster", H: "Parroting"},
		baseStats: {
			hp: 96,
			atk: 72,
			def: 65,
	...
	queengambit: {
		...
		num: 1093,
		types: ["Dark","Steel"],
		abilities: {0: "Pressure", 1: "Mythical Arrows", H: "Queen's Mourning"},
		baseStats: {
			hp: 75,
			atk: 81,
			def: 60,
	...
	pentadug: {
		...
		num: 1094,
		types: ["Ground"],
		abilities: {0: "Stamina", 1: "Sand Fiend", H: "Arena Trap"},
		baseStats: {
			hp: 90,
			atk: 120,
			def: 80,
	...
	crabominablemega: {
		...
		num: 740,
		types: ["Fighting","Ice"],
		abilities: {0: "Pressure", 1: "Icicle Fist", H: "Hyper Aggressive"},
		baseStats: {
			hp: 97,
			atk: 167,
			def: 132,
	...
	abyssand: {
		...
		num: 1095,
		types: ["Ghost","Ground"],
		abilities: {0: "Fort Knox", 1: "Earth Eater", H: "Sand Stream"},
		baseStats: {
			hp: 105,
			atk: 55,
			def: 75,
	...
	pentawug: {
		...
		num: 1096,
		types: ["Water"],
		abilities: {0: "Accelerate", 1: "Elude", H: "Sturdy"},
		baseStats: {
			hp: 70,
			atk: 120,
			def: 75,
	...
	ratiking: {
		...
		num: 1099,
		types: ["Normal"],
		abilities: {0: "King's Wrath", 1: "Pressure", H: "Looter"},
		baseStats: {
			hp: 123,
			atk: 113,
			def: 84,
	...
	ratfioso: {
		...
		num: 1100,
		types: ["Dark","Normal"],
		abilities: {0: "Low Blow", 1: "Gluttony", H: "Subdue"},
		baseStats: {
			hp: 105,
			atk: 96,
			def: 90,
	...
	guardozel: {
		...
		num: 1101,
		types: ["Water"],
		abilities: {0: "Friend Guard", 1: "Hospitality", H: "Hydrate"},
		baseStats: {
			hp: 90,
			atk: 70,
			def: 85,
	...
	beniccino: {
		...
		num: 1102,
		types: ["Normal"],
		abilities: {0: "Pixilate", 1: "Pickup", H: "Perfectionist"},
		baseStats: {
			hp: 95,
			atk: 125,
			def: 60,
	...
	bewarden: {
		...
		num: 1103,
		types: ["Normal","Fighting"],
		abilities: {0: "Scrappy", 1: "Intimidate", H: "Unaware"},
		baseStats: {
			hp: 130,
			atk: 135,
			def: 70,
	...
	torrentula: {
		...
		num: 1104,
		types: ["Water","Bug"],
		abilities: {0: "Foamy Web", 1: "Storm Drain", H: "Purifying Waters"},
		baseStats: {
			hp: 88,
			atk: 94,
			def: 102,
	...
	spindaze: {
		...
		num: 1105,
		types: ["Normal","Poison"],
		abilities: {0: "Let's Dance", 1: "Narcissist", H: "Contrary"},
		baseStats: {
			hp: 90,
			atk: 92,
			def: 78,
	...
	blocli: {
		...
		num: 1106,
		types: ["Normal"],
		abilities: {0: "Friend Guard", 1: "Immunity", H: "Self Sufficient"},
		baseStats: {
			hp: 55,
			atk: 40,
			def: 65,
	...
	bloxtack: {
		...
		num: 1107,
		types: ["Normal"],
		abilities: {0: "Overcoat", 1: "Immunity", H: "Self Sufficient"},
		baseStats: {
			hp: 65,
			atk: 60,
			def: 80,
	...
	gargablox: {
		...
		num: 1108,
		types: ["Normal"],
		abilities: {0: "Fort Knox", 1: "Immunity", H: "Self Repair"},
		baseStats: {
			hp: 95,
			atk: 80,
			def: 110,
	...
	hippopotato: {
		...
		num: 1109,
		types: ["Grass","Ground"],
		abilities: {0: "Intoxicate", 1: "Regenerator", H: "Storm Drain"},
		baseStats: {
			hp: 78,
			atk: 40,
			def: 66,
	...
	hippotaton: {
		...
		num: 1110,
		types: ["Grass","Ground"],
		abilities: {0: "Well Baked Body", 1: "Regenerator", H: "Natural Cure"},
		baseStats: {
			hp: 128,
			atk: 55,
			def: 116,
	...
	corntyrant: {
		...
		num: 1111,
		types: ["Grass","Dragon"],
		abilities: {0: "Overcoat", 1: "Primal Maw", H: "Sun's Bounty"},
		baseStats: {
			hp: 135,
			atk: 135,
			def: 135,
	...
	ironspirals: {
		...
		num: 1112,
		types: ["Ground","Psychic"],
		abilities: {0: "Energy Horns", 1: "Earth Eater", H: "Power Core"},
		baseStats: {
			hp: 98,
			atk: 68,
			def: 114,
	...
	ironsaber: {
		...
		num: 1114,
		types: ["Grass","Electric"],
		abilities: {0: "Intimidate", 1: "Sun's Bounty", H: "Merciless"},
		baseStats: {
			hp: 102,
			atk: 82,
			def: 104,
	...
	hypnocroak: {
		...
		num: 1115,
		types: ["Poison","Psychic"],
		abilities: {0: "Anticipation", 1: "Prankster", H: "Bad Dreams"},
		baseStats: {
			hp: 105,
			atk: 65,
			def: 100,
	...
	plundertow: {
		...
		num: 1131,
		types: ["Ghost","Grass"],
		abilities: {0: "Swift Swim", 1: "Raging Storm", H: "Vengeful Spirit"},
		baseStats: {
			hp: 83,
			atk: 121,
			def: 77,
	...
	qwilfishhisuian: {
		...
		num: 211,
		types: ["Dark","Poison"],
		abilities: {0: "Water Veil", 1: "Skill Link", H: "Intimidate"},
		baseStats: {
			hp: 65,
			atk: 95,
			def: 85,
	...
	growlithehisuian: {
		...
		num: 58,
		types: ["Fire","Rock"],
		abilities: {0: "Rock Head", 1: "Intimidate", H: "Mineralize"},
		baseStats: {
			hp: 60,
			atk: 75,
			def: 45,
	...
	voltorbhisuian: {
		...
		num: 100,
		types: ["Electric","Grass"],
		abilities: {0: "Chloroplast", 1: "Sap Sipper", H: "Speed Force"},
		baseStats: {
			hp: 40,
			atk: 30,
			def: 50,
	...
	electrodehisuian: {
		...
		num: 101,
		types: ["Electric","Grass"],
		abilities: {0: "Terminal Velocity", 1: "Sap Sipper", H: "Momentum"},
		baseStats: {
			hp: 60,
			atk: 50,
			def: 70,
	...
	typhlosionhisuian: {
		...
		num: 157,
		types: ["Fire","Ghost"],
		abilities: {0: "Early Grave", 1: "Ethereal Rush", H: "Set Ablaze"},
		baseStats: {
			hp: 93,
			atk: 74,
			def: 78,
	...
	sneaselhisuian: {
		...
		num: 215,
		types: ["Poison","Fighting"],
		abilities: {0: "Serene Grace", 1: "Corrosion", H: "Hyper Aggressive"},
		baseStats: {
			hp: 60,
			atk: 95,
			def: 55,
	...
	samurotthisuian: {
		...
		num: 503,
		types: ["Water","Dark"],
		abilities: {0: "Exploit Weakness", 1: "Raging Storm", H: "Merciless"},
		baseStats: {
			hp: 90,
			atk: 110,
			def: 80,
	...
	braviaryhisuian: {
		...
		num: 628,
		types: ["Psychic","Flying"],
		abilities: {0: "Sheer Force", 1: "North Wind", H: "Ethereal Rush"},
		baseStats: {
			hp: 100,
			atk: 57,
			def: 75,
	...
	sliggoohisuian: {
		...
		num: 705,
		types: ["Dragon","Steel"],
		abilities: {0: "Gooey", 1: "Bulletproof", H: "Juggernaut"},
		baseStats: {
			hp: 58,
			atk: 75,
			def: 83,
	...
	avalugghisuian: {
		...
		num: 713,
		types: ["Ice","Rock"],
		abilities: {0: "Technician", 1: "Self Sufficient", H: "Fort Knox"},
		baseStats: {
			hp: 95,
			atk: 127,
			def: 184,
	...
	decidueyehisuian: {
		...
		num: 724,
		types: ["Grass","Fighting"],
		abilities: {0: "Archer", 1: "Scrappy", H: "Opportunist"},
		baseStats: {
			hp: 90,
			atk: 120,
			def: 90,
	...
	zoruahisuian: {
		...
		num: 570,
		types: ["Normal","Ghost"],
		abilities: {0: "Ambush", 1: "Shallow Grave", H: "Exploit Weakness"},
		baseStats: {
			hp: 35,
			atk: 60,
			def: 40,
	...
	zoroarkhisuian: {
		...
		num: 571,
		types: ["Normal","Ghost"],
		abilities: {0: "Ambush", 1: "Shallow Grave", H: "Snow Cloak"},
		baseStats: {
			hp: 55,
			atk: 100,
			def: 60,
	...
	taurospaldeanaquabreed: {
		...
		num: 128,
		types: ["Fighting","Water"],
		abilities: {0: "Violent Rush", 1: "Hydrate", H: "Cud Chew"},
		baseStats: {
			hp: 95,
			atk: 130,
			def: 105,
	...
	taurospaldeanblazebreed: {
		...
		num: 128,
		types: ["Fighting","Fire"],
		abilities: {0: "Violent Rush", 1: "Immolate", H: "Cud Chew"},
		baseStats: {
			hp: 95,
			atk: 130,
			def: 105,
	...
	taurospaldeancombatbreed: {
		...
		num: 128,
		types: ["Fighting"],
		abilities: {0: "Hyper Aggressive", 1: "Anger Point", H: "Cud Chew"},
		baseStats: {
			hp: 95,
			atk: 130,
			def: 105,
	...
	ursalunabloodmoon: {
		...
		num: 901,
		types: ["Ground","Normal"],
		abilities: {0: "Voodoo Power", 1: "Scare", H: "Blood Price"},
		baseStats: {
			hp: 113,
			atk: 70,
			def: 120,
	...
	tatsugiricurly: {
		...
		num: 978,
		types: ["Dragon","Water"],
		abilities: {0: "Commander", 1: "Multiscale", H: "Tactical Retreat"},
		baseStats: {
			hp: 68,
			atk: 50,
			def: 60,
	...
	ogerponwellspringmask: {
		...
		num: 1017,
		types: ["Grass","Water"],
		abilities: {0: "Water Veil", 1: "Tidal Rush", H: "Cloud Nine"},
		baseStats: {
			hp: 80,
			atk: 120,
			def: 84,
	...
	ogerponhearthflame: {
		...
		num: 1017,
		types: ["Grass","Fire"],
		abilities: {0: "Hyper Aggressive", 1: "Flaming Soul", H: "Mold Breaker"},
		baseStats: {
			hp: 80,
			atk: 120,
			def: 84,
	...
	ogerponcornerstone: {
		...
		num: 1017,
		types: ["Grass","Rock"],
		abilities: {0: "Loose Rocks", 1: "Impenetrable", H: "Sturdy"},
		baseStats: {
			hp: 80,
			atk: 120,
			def: 84,
	...
	polarticbluemoon: {
		...
		num: 1031,
		types: ["Ice","Fighting"],
		abilities: {0: "Sheer Force", 1: "Predator", H: "Fearmonger"},
		baseStats: {
			hp: 130,
			atk: 145,
			def: 70,
	...
	lumberingslothengulfed: {
		...
		num: 1049,
		types: ["Fire","Grass"],
		abilities: {0: "Hyper Aggressive", 1: "Forest Rage", H: "Volcano Rage"},
		baseStats: {
			hp: 109,
			atk: 135,
			def: 65,
	...
	basculegionf: {
		...
		num: 902,
		types: ["Water","Ghost"],
		abilities: {0: "Rapid Response", 1: "Guilt Trip", H: "Spectralize"},
		baseStats: {
			hp: 130,
			atk: 75,
			def: 65,
	...
	meowthpartner: {
		...
		num: 52,
		types: ["Normal"],
		abilities: {0: "Opportunist", 1: "Equinox", H: "Skill Link"},
		baseStats: {
			hp: 50,
			atk: 90,
			def: 45,
	...
	slakingmegaapeshift: {
		...
		num: 289,
		types: ["Normal","Ice"],
		abilities: {0: "Unseen Fist", 1: "Know Your Place", H: "Contempt"},
		baseStats: {
			hp: 130,
			atk: 210,
			def: 110,
	...
	raichumegay: {
		...
		num: 26,
		types: ["Electric"],
		abilities: {0: "Power Outage", 1: "Power Outage", H: "Power Outage"},
		baseStats: {
			hp: 60,
			atk: 100,
			def: 60,
	...
	castformfoggy: {
		...
		num: 351,
		types: ["Ghost"],
		abilities: {0: "Ethereal Rush", 1: "Ectoplasm", H: "Early Grave"},
		baseStats: {
			hp: 75,
			atk: 75,
			def: 75,
	...
	fidoughpartner: {
		name: "Fidough-Partner",
		num: 926,
		types: ["Fairy"],
		abilities: {0: "Sharing Is Caring", 1: "Soothing Aroma", H: "Pretty Privilege"},
		baseStats: {
			hp: 80,
			atk: 75,
			def: 70,
	...
	chesnaughtbattlebond: {
		...
		num: 652,
		types: ["Grass","Fighting"],
		abilities: {0: "Loose Quills", 1: "Stamina", H: "Spike Armor"},
		baseStats: {
			hp: 88,
			atk: 107,
			def: 122,
	...
	chesnaughtclemont: {
		...
		num: 652,
		types: ["Grass","Fighting"],
		abilities: {0: "Faraday Cage", 1: "Galvanize", H: "Self Repair"},
		baseStats: {
			hp: 88,
			atk: 128,
			def: 152,
	...
	delphoxbattlebond: {
		...
		num: 655,
		types: ["Fire","Psychic"],
		abilities: {0: "Adaptability", 1: "Pyromancy", H: "Subdue"},
		baseStats: {
			hp: 75,
			atk: 69,
			def: 72,
	...
	morpekyllhangry: {
		...
		num: 1119,
		types: ["Electric","Dark"],
		abilities: {0: "Gluttony", 1: "Unburden", H: "Menacing Situation"},
		baseStats: {
			hp: 87,
			atk: 121,
			def: 78,
	...
	lycanroceclipse: {
		...
		num: 745,
		types: ["Rock","Ghost"],
		abilities: {0: "Sturdy", 1: "Smokey Maneuvers", H: "Weak Armor"},
		baseStats: {
			hp: 85,
			atk: 76,
			def: 55,
	...
	lycanroctwilight: {
		...
		num: 745,
		types: ["Rock","Fairy"],
		abilities: {0: "Mind Crunch", 1: "On The Prowl", H: "Determination"},
		baseStats: {
			hp: 92,
			atk: 53,
			def: 75,
	...
	falinksmega: {
		...
		num: 870,
		types: ["Fighting"],
		abilities: {0: "Fort Knox", 1: "Mold Breaker", H: "Friend Guard"},
		baseStats: {
			hp: 65,
			atk: 135,
			def: 135,
	...
	pyroarmega: {
		...
		num: 668,
		types: ["Normal","Fire"],
		abilities: {0: "Adaptability", 1: "Hubris", H: "Fire's Wrath"},
		baseStats: {
			hp: 86,
			atk: 88,
			def: 92,
	...
	chesnaughtmega: {
		...
		num: 652,
		types: ["Grass","Fighting"],
		abilities: {0: "King's Wrath", 1: "Chestnut Shield", H: "Chestnut Axe"},
		baseStats: {
			hp: 88,
			atk: 137,
			def: 172,
	...
	delphoxmega: {
		...
		num: 655,
		types: ["Fire","Psychic"],
		abilities: {0: "Deadly Precision", 1: "Mystic Power", H: "Forewarn"},
		baseStats: {
			hp: 75,
			atk: 69,
			def: 73,
	...
	greninjamega: {
		...
		num: 658,
		types: ["Water","Dark"],
		abilities: {0: "Fatal Precision", 1: "Rain Shroud", H: "Protean"},
		baseStats: {
			hp: 72,
			atk: 125,
			def: 77,
	...
	eelektrossmega: {
		...
		num: 604,
		types: ["Electric"],
		abilities: {0: "Electromorphosis", 1: "Nosferatu", H: "Polarity"},
		baseStats: {
			hp: 85,
			atk: 145,
			def: 90,
	...
	malamarmega: {
		...
		num: 687,
		types: ["Dark","Psychic"],
		abilities: {0: "Entrance", 1: "Inversion", H: "Infiltrator"},
		baseStats: {
			hp: 86,
			atk: 102,
			def: 88,
	...
	victreebelmega: {
		...
		num: 71,
		types: ["Grass","Poison"],
		abilities: {0: "Hyper Aggressive", 1: "Poison Absorb", H: "Aroma Veil"},
		baseStats: {
			hp: 100,
			atk: 125,
			def: 95,
	...
	dragalgemega: {
		...
		num: 691,
		types: ["Poison","Dragon"],
		abilities: {0: "Protean", 1: "Contrary", H: "Toxic Surge"},
		baseStats: {
			hp: 85,
			atk: 97,
			def: 105,
	...
	hawluchamega: {
		...
		num: 701,
		types: ["Fighting","Flying"],
		abilities: {0: "Good As Gold", 1: "Combat Specialist", H: "Wrestle Showman"},
		baseStats: {
			hp: 78,
			atk: 137,
			def: 100,
	...
	clefablemegay: {
		...
		num: 36,
		types: ["Fairy","Flying"],
		abilities: {0: "Lepidopteran", 1: "Lepidopteran", H: "Lepidopteran"},
		baseStats: {
			hp: 100,
			atk: 80,
			def: 95,
	...
	dragonitemegay: {
		...
		num: 149,
		types: ["Dragon","Flying"],
		abilities: {0: "Serene Grace", 1: "Cloud Nine", H: "Wishmaker"},
		baseStats: {
			hp: 91,
			atk: 124,
			def: 115,
	...
	excadrillmega: {
		...
		num: 530,
		types: ["Ground","Steel"],
		abilities: {0: "Mold Breaker", 1: "Sand Rush", H: "Sand Guard"},
		baseStats: {
			hp: 110,
			atk: 165,
			def: 100,
	...
	scolipedemega: {
		...
		num: 545,
		types: ["Bug","Poison"],
		abilities: {0: "Tinted Lens", 1: "Self Repair", H: "Dauntless Shield"},
		baseStats: {
			hp: 90,
			atk: 140,
			def: 159,
	...
	chandeluremegay: {
		...
		num: 609,
		types: ["Ghost","Fire"],
		abilities: {0: "Purgatory", 1: "Shadow Shield", H: "Foggy Eye"},
		baseStats: {
			hp: 80,
			atk: 75,
			def: 110,
	...
	floetteeternalflowermega: {
		...
		num: 670,
		types: ["Fairy"],
		abilities: {0: "Energy Siphon", 1: "Misty Surge", H: "Artillery"},
		baseStats: {
			hp: 74,
			atk: 85,
			def: 87,
	...
	zygardecompletemega: {
		...
		num: 718,
		types: ["Dragon","Ground"],
		abilities: {0: "Nihil Blaster", 1: "Nihil Blaster", H: "Nihil Blaster"},
		baseStats: {
			hp: 216,
			atk: 70,
			def: 121,
	...
	barbaraclemega: {
		...
		num: 689,
		types: ["Rock","Fighting"],
		abilities: {0: "Frisk", 1: "Anticipation", H: "Vital Spirit"},
		baseStats: {
			hp: 72,
			atk: 140,
			def: 130,
	...
	drampamega: {
		...
		num: 780,
		types: ["Normal","Dragon"],
		abilities: {0: "Storm Cloud", 1: "Storm Cloud", H: "Storm Cloud"},
		baseStats: {
			hp: 78,
			atk: 95,
			def: 110,
	...
	starmiemega: {
		...
		num: 121,
		types: ["Water","Psychic"],
		abilities: {0: "Huge Power", 1: "Huge Power", H: "Huge Power"},
		baseStats: {
			hp: 60,
			atk: 100,
			def: 110,
	...
	skarmorymegay: {
		...
		num: 227,
		types: ["Steel","Flying"],
		abilities: {0: "Talon Trap", 1: "Talon Trap", H: "Talon Trap"},
		baseStats: {
			hp: 75,
			atk: 140,
			def: 110,
	...
	froslassmegay: {
		...
		num: 478,
		types: ["Ice","Ghost"],
		abilities: {0: "Cryomancy", 1: "Frostbind", H: "Bad Luck"},
		baseStats: {
			hp: 70,
			atk: 80,
			def: 70,
	...
	wigglytuffmegax: {
		...
		abilities: {0: "Violent Rush", 1: "Opportunist", H: "Scrappy"},
		baseStats: {
			hp: 120,
			atk: 133,
			def: 45,
	...
	wigglytuffmega: {
		...
		num: 40,
		types: ["Fire","Fairy"],
		abilities: {0: "Combustion", 1: "Tipping Point", H: "Magic Guard"},
		baseStats: {
			hp: 120,
			atk: 90,
			def: 55,
	...
	lucariomegaz: {
		...
		num: 448,
		types: ["Fighting","Steel"],
		abilities: {0: "Aura Armor", 1: "Aura Armor", H: "Aura Armor"},
		baseStats: {
			hp: 70,
			atk: 100,
			def: 70,
	...
	gyaradeathmegay: {
		...
		num: 1041,
		types: ["Ghost","Psychic"],
		abilities: {0: "Psychic Surge", 1: "Hubris", H: "Mystic Power"},
		baseStats: {
			hp: 95,
			atk: 110,
			def: 90,
	...
	arbokmega: {
		...
		num: 24,
		types: ["Poison","Dark"],
		abilities: {0: "Pattern Change", 1: "Petrify", H: "Neurotoxin"},
		baseStats: {
			hp: 90,
			atk: 130,
			def: 94,
	...
	golisopodmegay: {
		...
		num: 768,
		types: ["Bug","Water"],
		abilities: {0: "No Turning Back", 1: "No Turning Back", H: "No Turning Back"},
		baseStats: {
			hp: 75,
			atk: 155,
			def: 140,
	...
	rapidashmega: {
		...
		num: 78,
		types: ["Fire","Electric"],
		abilities: {0: "Reckless", 1: "Turboblaze", H: "Mighty Horn"},
		baseStats: {
			hp: 85,
			atk: 130,
			def: 100,
	...
	rapidashmegagalarian: {
		...
		num: 78,
		types: ["Psychic","Fairy"],
		abilities: {0: "Mystic Blades", 1: "Radiance", H: "Dazzling"},
		baseStats: {
			hp: 85,
			atk: 105,
			def: 90,
	...
	oricoriomega: {
		...
		num: 741,
		types: ["Flying"],
		abilities: {0: "Dancer", 1: "Prankster", H: "Two Step"},
		baseStats: {
			hp: 75,
			atk: 70,
			def: 90,
	...
	cormothmega: {
		...
		num: 1046,
		types: ["Grass"],
		abilities: {0: "Grass Pelt", 1: "Butter Up", H: "Overcoat"},
		baseStats: {
			hp: 95,
			atk: 70,
			def: 135,
	...
	popcormmega: {
		...
		num: 1047,
		types: ["Grass","Fire"],
		abilities: {0: "Butter Up", 1: "Solar Power", H: "Technician"},
		baseStats: {
			hp: 95,
			atk: 120,
			def: 60,
	...
	amphybuzzmega: {
		...
		num: 1057,
		types: ["Bug","Fairy"],
		abilities: {0: "Queen's Mourning", 1: "Queenly Majesty", H: "Mold Breaker"},
		baseStats: {
			hp: 110,
			atk: 95,
			def: 105,
	...
	urshifumega: {
		...
		num: 892,
		types: ["Fighting","Dark"],
		abilities: {0: "Way Of Precision", 1: "Way Of Precision", H: "Way Of Precision"},
		baseStats: {
			hp: 100,
			atk: 200,
			def: 120,
	...
	urshifurapidstrikestylemega: {
		...
		num: 892,
		types: ["Fighting","Water"],
		abilities: {0: "Way Of Swiftness", 1: "Way Of Swiftness", H: "Way Of Swiftness"},
		baseStats: {
			hp: 90,
			atk: 170,
			def: 100,
	...
	melmetalmega: {
		...
		num: 809,
		types: ["Steel"],
		abilities: {0: "Atomic Punch", 1: "Atomic Punch", H: "Atomic Punch"},
		baseStats: {
			hp: 135,
			atk: 183,
			def: 183,
	...
	venusaurmegax: {
		...
		num: 3,
		types: ["Grass","Poison"],
		abilities: {0: "Energy Siphon", 1: "Energy Siphon", H: "Energy Siphon"},
		baseStats: {
			hp: 90,
			atk: 125,
			def: 130,
	...
	blastoisemegax: {
		...
		num: 9,
		types: ["Water","Steel"],
		abilities: {0: "Dauntless Shield", 1: "Dauntless Shield", H: "Dauntless Shield"},
		baseStats: {
			hp: 84,
			atk: 145,
			def: 125,
	...
	gengarmegax: {
		...
		num: 94,
		types: ["Ghost","Poison"],
		abilities: {0: "Shadow Tag", 1: "Phantom Pain", H: "Strong Jaw"},
		baseStats: {
			hp: 65,
			atk: 155,
			def: 100,
	...
	snorlaxmega: {
		...
		num: 143,
		types: ["Normal","Grass"],
		abilities: {0: "Raw Wood", 1: "Flourish", H: "Comatose"},
		baseStats: {
			hp: 160,
			atk: 130,
			def: 65,
	...
	rillaboommega: {
		...
		num: 812,
		types: ["Grass"],
		abilities: {0: "Rhythmic", 1: "Long Reach", H: "Grass Pelt"},
		baseStats: {
			hp: 100,
			atk: 150,
			def: 105,
	...
	cinderacemega: {
		...
		num: 815,
		types: ["Fire"],
		abilities: {0: "Deadeye", 1: "Turboblaze", H: "Defiant"},
		baseStats: {
			hp: 80,
			atk: 145,
			def: 90,
	...
	inteleonmega: {
		...
		num: 818,
		types: ["Water"],
		abilities: {0: "Deadeye", 1: "Terminal Velocity", H: "Super Luck"},
		baseStats: {
			hp: 75,
			atk: 125,
			def: 70,
	...
	corviknightmega: {
		...
		num: 823,
		types: ["Flying","Steel"],
		abilities: {0: "Frisk", 1: "Air Blower", H: "Impenetrable"},
		baseStats: {
			hp: 98,
			atk: 68,
			def: 110,
	...
	drednawmega: {
		...
		num: 834,
		types: ["Water","Dragon"],
		abilities: {0: "Mountaineer", 1: "Dragon's Maw", H: "Loose Rocks"},
		baseStats: {
			hp: 90,
			atk: 145,
			def: 120,
	...
	coalossalmega: {
		...
		num: 839,
		types: ["Rock","Fire"],
		abilities: {0: "Earth Eater", 1: "Earth Eater", H: "Earth Eater"},
		baseStats: {
			hp: 110,
			atk: 100,
			def: 100,
	...
	sandacondamega: {
		...
		num: 844,
		types: ["Ground","Flying"],
		abilities: {0: "Sand Rush", 1: "Sand Force", H: "Artillery"},
		baseStats: {
			hp: 72,
			atk: 70,
			def: 135,
	...
	copperajahmega: {
		...
		num: 879,
		types: ["Steel"],
		abilities: {0: "Stall", 1: "Sap Sipper", H: "Growing Tooth"},
		baseStats: {
			hp: 122,
			atk: 160,
			def: 109,
	...
	hatterenemega: {
		...
		num: 858,
		types: ["Psychic","Fairy"],
		abilities: {0: "Raging Goddess", 1: "Raging Goddess", H: "Raging Goddess"},
		baseStats: {
			hp: 57,
			atk: 110,
			def: 95,
	...
	garbodormega: {
		...
		num: 569,
		types: ["Poison","Steel"],
		abilities: {0: "Permanence", 1: "Malodor", H: "Fort Knox"},
		baseStats: {
			hp: 80,
			atk: 130,
			def: 102,
	...
	orbeetlemega: {
		...
		num: 826,
		types: ["Bug","Psychic"],
		abilities: {0: "Power Spot", 1: "Psychic Surge", H: "Magic Bounce"},
		baseStats: {
			hp: 60,
			atk: 65,
			def: 130,
	...
	grimmsnarlmega: {
		...
		num: 861,
		types: ["Dark","Fairy"],
		abilities: {0: "Fearmonger", 1: "Fearmonger", H: "Fearmonger"},
		baseStats: {
			hp: 95,
			atk: 140,
			def: 75,
	...
	centiskorchmega: {
		...
		num: 851,
		types: ["Fire","Bug"],
		abilities: {0: "Mountaineer", 1: "Flaming Maw", H: "Dragonslayer"},
		baseStats: {
			hp: 100,
			atk: 165,
			def: 90,
	...
	alcremiemega: {
		...
		num: 869,
		types: ["Fairy"],
		abilities: {0: "Natural Cure", 1: "Well Baked Body", H: "Misty Surge"},
		baseStats: {
			hp: 75,
			atk: 80,
			def: 80,
	...
	toxtricitymega: {
		...
		num: 849,
		types: ["Electric","Poison"],
		abilities: {0: "Stun Shock", 1: "Stun Shock", H: "Stun Shock"},
		baseStats: {
			hp: 75,
			atk: 82,
			def: 90,
	...
	eeveepartnermega: {
		...
		num: 133,
		types: ["Normal"],
		abilities: {0: "Prankster", 1: "Scrappy", H: "Friend Guard"},
		baseStats: {
			hp: 65,
			atk: 125,
			def: 65,
	...
	meowthpartnermega: {
		...
		num: 52,
		types: ["Normal"],
		abilities: {0: "Good As Gold", 1: "Higher Rank", H: "Scrappy"},
		baseStats: {
			hp: 50,
			atk: 140,
			def: 75,
	...
	fidoughmega: {
		...
		num: 926,
		types: ["Fairy"],
		abilities: {0: "Misty Surge", 1: "Rising Dough", H: "Pretty Privilege"},
		baseStats: {
			hp: 80,
			atk: 110,
			def: 110,
	...
	weavilemega: {
		...
		num: 461,
		types: ["Dark","Ice"],
		abilities: {0: "Hyper Aggressive", 1: "Violent Rush", H: "Technician"},
		baseStats: {
			hp: 70,
			atk: 135,
			def: 85,
	...
	serperiormega: {
		...
		num: 497,
		types: ["Grass","Dragon"],
		abilities: {0: "Scare", 1: "Dragon's Maw", H: "Contrary"},
		baseStats: {
			hp: 83,
			atk: 87,
			def: 125,
	...
	emboarmega: {
		...
		num: 500,
		types: ["Fire","Fighting"],
		abilities: {0: "Fire Ruler", 1: "Fire Ruler", H: "Fire Ruler"},
		baseStats: {
			hp: 110,
			atk: 148,
			def: 75,
	...
	samurottmega: {
		...
		num: 503,
		types: ["Water","Fighting"],
		abilities: {0: "Mystic Blades", 1: "Swift Swim", H: "Cutthroat"},
		baseStats: {
			hp: 95,
			atk: 120,
			def: 100,
	...
	decidueyemega: {
		...
		num: 724,
		types: ["Grass","Ghost"],
		abilities: {0: "Hunter's Mark", 1: "Hunter's Mark", H: "Hunter's Mark"},
		baseStats: {
			hp: 78,
			atk: 127,
			def: 75,
	...
	decidueyehisuianmega: {
		...
		num: 724,
		types: ["Grass","Fighting"],
		abilities: {0: "Junshisanda", 1: "Junshisanda", H: "Junshisanda"},
		baseStats: {
			hp: 90,
			atk: 150,
			def: 100,
	...
	incineroarmega: {
		...
		num: 727,
		types: ["Fire","Dark"],
		abilities: {0: "Champion's Entrance", 1: "Champion's Entrance", H: "Champion's Entrance"},
		baseStats: {
			hp: 100,
			atk: 135,
			def: 110,
	...
	meowscaradamega: {
		...
		num: 908,
		types: ["Grass","Dark"],
		abilities: {0: "Conjurer Of Deceit", 1: "Conjurer Of Deceit", H: "Conjurer Of Deceit"},
		baseStats: {
			hp: 81,
			atk: 140,
			def: 70,
	...
	primarinamega: {
		...
		num: 730,
		types: ["Water","Fairy"],
		abilities: {0: "Presto", 1: "Presto", H: "Presto"},
		baseStats: {
			hp: 80,
			atk: 104,
			def: 94,
	...
	quaquavalmega: {
		...
		num: 914,
		types: ["Water","Fighting"],
		abilities: {0: "Gladiator", 1: "Gladiator", H: "Gladiator"},
		baseStats: {
			hp: 85,
			atk: 140,
			def: 115,
	...
	samurotthisuianmega: {
		...
		num: 503,
		types: ["Water","Dark"],
		abilities: {0: "Relentless", 1: "Relentless", H: "Relentless"},
		baseStats: {
			hp: 90,
			atk: 148,
			def: 90,
	...
	skeledirgemega: {
		...
		num: 911,
		types: ["Fire","Ghost"],
		abilities: {0: "Banshee", 1: "Banshee", H: "Banshee"},
		baseStats: {
			hp: 104,
			atk: 95,
			def: 120,
	...
	typhlosionhisuianmega: {
		...
		num: 157,
		types: ["Fire","Ghost"],
		abilities: {0: "Soul Devourer", 1: "Soul Devourer", H: "Soul Devourer"},
		baseStats: {
			hp: 93,
			atk: 89,
			def: 101,
	...
	mienshaomega: {
		...
		num: 620,
		types: ["Fighting","Flying"],
		abilities: {0: "Aerodynamics", 1: "Aerodynamics", H: "Aerodynamics"},
		baseStats: {
			hp: 65,
			atk: 150,
			def: 65,
	...
	arcaninemega: {
		...
		num: 59,
		types: ["Fire"],
		abilities: {0: "Tough Claws", 1: "Tough Claws", H: "Tough Claws"},
		baseStats: {
			hp: 90,
			atk: 145,
			def: 100,
	...
	goodramega: {
		...
		num: 706,
		types: ["Dragon"],
		abilities: {0: "Poison Absorb", 1: "Overcoat", H: "Drizzle"},
		baseStats: {
			hp: 90,
			atk: 125,
			def: 85,
	...
	slowbromegagalarian: {
		...
		num: 80,
		types: ["Poison","Psychic"],
		abilities: {0: "Unaware", 1: "Artillery", H: "Regenerator"},
		baseStats: {
			hp: 95,
			atk: 150,
			def: 110,
	...
	slowkingmegagalarian: {
		...
		num: 199,
		types: ["Poison","Psychic"],
		abilities: {0: "Poison Absorb", 1: "Analytic", H: "Unaware"},
		baseStats: {
			hp: 95,
			atk: 70,
			def: 110,
	...
	roserademega: {
		...
		num: 407,
		types: ["Grass","Poison"],
		abilities: {0: "Technician", 1: "Rose Garden", H: "Corrosion"},
		baseStats: {
			hp: 60,
			atk: 145,
			def: 70,
	...
	clodsiremega: {
		...
		num: 980,
		types: ["Poison","Ground"],
		abilities: {0: "Wonder Skin", 1: "Unaware", H: "Toxic Debris"},
		baseStats: {
			hp: 130,
			atk: 145,
			def: 110,
	...
	gothitellemega: {
		...
		num: 576,
		types: ["Psychic","Dark"],
		abilities: {0: "Mental Pollution", 1: "Cosmic Daze", H: "Bad Luck"},
		baseStats: {
			hp: 80,
			atk: 80,
			def: 120,
	...
	reuniclusmega: {
		...
		num: 579,
		types: ["Psychic"],
		abilities: {0: "Magical Fists", 1: "Hustle", H: "Iron Fist"},
		baseStats: {
			hp: 110,
			atk: 135,
			def: 105,
	...
	kipmodo: {
		...
		num: 1086,
		types: ["Dragon","Poison"],
		abilities: {0: "Unaware", 1: "Dragon's Maw", H: "Merciless"},
		baseStats: {
			hp: 50,
			atk: 61,
			def: 53,
	...
	marshmodo: {
		...
		num: 1087,
		types: ["Dragon","Poison"],
		abilities: {0: "Regenerator", 1: "Biofilm", H: "Unaware"},
		baseStats: {
			hp: 65,
			atk: 85,
			def: 65,
	...
	swampage: {
		...
		num: 1088,
		types: ["Dragon","Poison"],
		abilities: {0: "Regenerator", 1: "Adrenaline Rush", H: "Sludge Spit"},
		baseStats: {
			hp: 95,
			atk: 115,
			def: 75,
	...
	swampagemega: {
		...
		num: 1088,
		types: ["Dragon","Poison"],
		abilities: {0: "Swamp Thing", 1: "Swamp Thing", H: "Swamp Thing"},
		baseStats: {
			hp: 95,
			atk: 143,
			def: 98,
	...
	chandeluremega: {
		...
		num: 609,
		types: ["Ghost","Fire"],
		abilities: {0: "Friend Guard", 1: "Flame Shield", H: "Hellblaze"},
		baseStats: {
			hp: 80,
			atk: 65,
			def: 100,
	...
	zapdosexmega: {
		...
		num: 145,
		types: ["Electric","Flying"],
		abilities: {0: "Thunderstorm Aspect", 1: "Supercell", H: "Supercell"},
		baseStats: {
			hp: 90,
			atk: 110,
			def: 85,
	...
	articunoexmega: {
		...
		num: 144,
		types: ["Ice","Flying"],
		abilities: {0: "Aurora's Gale", 1: "Aurora's Gale", H: "Aurora's Gale"},
		baseStats: {
			hp: 90,
			atk: 85,
			def: 130,
	...
	moltresexmega: {
		...
		num: 146,
		types: ["Fire","Flying"],
		abilities: {0: "Blistering Sun", 1: "Blistering Sun", H: "Blistering Sun"},
		baseStats: {
			hp: 90,
			atk: 100,
			def: 95,
	...
	zapdosex: {
		...
		num: 145,
		types: ["Electric","Flying"],
		abilities: {0: "Overcharge", 1: "Gale Wings", H: "Drizzle"},
		baseStats: {
			hp: 90,
			atk: 90,
			def: 85,
	...
	articunoex: {
		...
		num: 144,
		types: ["Ice","Flying"],
		abilities: {0: "North Wind", 1: "Snow Warning", H: "Ice Scales"},
		baseStats: {
			hp: 90,
			atk: 85,
			def: 110,
	...
	moltresex: {
		...
		num: 146,
		types: ["Fire","Flying"],
		abilities: {0: "Air Blower", 1: "Flaming Soul", H: "Drought"},
		baseStats: {
			hp: 90,
			atk: 100,
			def: 90,
	...
	frostuccino: {
		...
		num: 1123,
		types: ["Ice","Fairy"],
		abilities: {0: "Chilling Pellets", 1: "Cute Charm", H: "Whiteout"},
		baseStats: {
			hp: 95,
			atk: 105,
			def: 70,
	...
	talonflamemega: {
		...
		num: 663,
		types: ["Fire","Flying"],
		abilities: {0: "Galeforce Wings", 1: "Galeforce Wings", H: "Galeforce Wings"},
		baseStats: {
			hp: 78,
			atk: 121,
			def: 91,
	...
	carbonixmega: {
		...
		num: 1127,
		types: ["Rock","Dragon"],
		abilities: {0: "Desert Cloak", 1: "Impenetrable", H: "Earth Eater"},
		baseStats: {
			hp: 75,
			atk: 55,
			def: 105,
	...
	grotomglass: {
		...
		num: 1128,
		types: ["Poison","Rock"],
		abilities: {0: "Sharp Edges", 1: "Deep Cuts", H: "Unburden"},
		baseStats: {
			hp: 70,
			atk: 110,
			def: 107,
	...
	grotomroll: {
		...
		num: 1128,
		types: ["Poison","Ground"],
		abilities: {0: "Inflatable", 1: "Speed Boost", H: "Dust Cloud"},
		baseStats: {
			hp: 70,
			atk: 110,
			def: 107,
	...
	grotomdrum: {
		...
		num: 1128,
		types: ["Poison","Steel"],
		abilities: {0: "Fort Knox", 1: "Full Metal Body", H: "Juggernaut"},
		baseStats: {
			hp: 70,
			atk: 110,
			def: 107,
	...
	grotomkick: {
		...
		num: 1128,
		types: ["Poison","Fighting"],
		abilities: {0: "Roundhouse", 1: "Scrappy", H: "Quick Feet"},
		baseStats: {
			hp: 70,
			atk: 110,
			def: 107,
	...
	grotomfill: {
		...
		num: 1128,
		types: ["Poison","Dark"],
		abilities: {0: "Innards Out", 1: "Gluttony", H: "Stench"},
		baseStats: {
			hp: 70,
			atk: 110,
			def: 107,
	...
	heracreusmega: {
		...
		num: 1091,
		types: ["Grass","Fairy"],
		abilities: {0: "Venom Crown", 1: "Dual Wield", H: "Grass Pelt"},
		baseStats: {
			hp: 75,
			atk: 120,
			def: 130,
	...
	dragapultmega: {
		...
		num: 887,
		types: ["Dragon","Ghost"],
		abilities: {0: "Blur", 1: "Speed Boost", H: "Elude"},
		baseStats: {
			hp: 88,
			atk: 125,
			def: 93,
	...
	sandslashalolamega: {
		...
		num: 28,
		types: ["Ice","Steel"],
		abilities: {0: "Whiteout", 1: "Permafrost", H: "Watch Your Step"},
		baseStats: {
			hp: 95,
			atk: 125,
			def: 135,
	...
	kleavormega: {
		...
		num: 900,
		types: ["Bug","Rock"],
		abilities: {0: "Mineralize", 1: "Cutthroat", H: "Relic Stone"},
		baseStats: {
			hp: 70,
			atk: 165,
			def: 130,
	...
	scythermega: {
		...
		num: 123,
		types: ["Bug","Flying"],
		abilities: {0: "Aerilate", 1: "Mystic Blades", H: "Quick Draw"},
		baseStats: {
			hp: 70,
			atk: 130,
			def: 80,
	...
	hydreigonmega: {
		...
		num: 635,
		types: ["Dark","Dragon"],
		abilities: {0: "Wings Of Pestilence", 1: "Wings Of Pestilence", H: "Wings Of Pestilence"},
		baseStats: {
			hp: 92,
			atk: 115,
			def: 123,
	...
	pentadugalolan: {
		...
		num: 1094,
		types: ["Ground","Steel"],
		abilities: {0: "Costar", 1: "Moustache", H: "Steelworker"},
		baseStats: {
			hp: 95,
			atk: 120,
			def: 90,
	...
	rexcadrill: {
		...
		num: 1097,
		types: ["Dragon","Ground"],
		abilities: {0: "Tough Claws", 1: "Hardened Sheath", H: "Loose Rocks"},
		baseStats: {
			hp: 118,
			atk: 135,
			def: 85,
	...
	selenumbra: {
		...
		num: 1098,
		types: ["Bug","Dark"],
		abilities: {0: "Moon Spirit", 1: "Dark Aura", H: "Sheer Force"},
		baseStats: {
			hp: 85,
			atk: 65,
			def: 85,
	...
	sneaslermega: {
		...
		num: 903,
		types: ["Fighting","Poison"],
		abilities: {0: "Weak Armor", 1: "Merciless", H: "Sheer Force"},
		baseStats: {
			hp: 80,
			atk: 155,
			def: 70,
	...
	clefablemega: {
		...
		num: 36,
		types: ["Fairy"],
		abilities: {0: "Dazzling", 1: "Wonder Skin", H: "Fairy Aura"},
		baseStats: {
			hp: 100,
			atk: 60,
			def: 115,
	...
	tsareenamega: {
		...
		num: 763,
		types: ["Grass","Fighting"],
		abilities: {0: "Defiant", 1: "Roundhouse", H: "Pretty Princess"},
		baseStats: {
			hp: 72,
			atk: 142,
			def: 108,
	...
	goodrahisuianmega: {
		...
		num: 706,
		types: ["Dragon","Steel"],
		abilities: {0: "Gooey", 1: "Cloud Nine", H: "Mirror Armor"},
		baseStats: {
			hp: 80,
			atk: 130,
			def: 140,
	...
	hariyamamega: {
		...
		num: 297,
		types: ["Fighting"],
		abilities: {0: "Steadfast", 1: "Fighting Spirit", H: "Stalwart"},
		baseStats: {
			hp: 144,
			atk: 130,
			def: 100,
	...
	eraticate: {
		...
		num: 1113,
		types: ["Poison","Fighting"],
		abilities: {0: "Rat King", 1: "Fur Coat", H: "Hustle"},
		baseStats: {
			hp: 100,
			atk: 122,
			def: 90,
	...
	luxzeromega: {
		...
		num: 1118,
		types: ["Electric","Ice"],
		abilities: {0: "Hyper Aggressive", 1: "Deep Freeze", H: "Cryo Architect"},
		baseStats: {
			hp: 75,
			atk: 125,
			def: 84,
	...
	luxzero: {
		...
		num: 1118,
		types: ["Electric","Ice"],
		abilities: {0: "Pressure", 1: "Deep Freeze", H: "Water Absorb"},
		baseStats: {
			hp: 75,
			atk: 110,
			def: 74,
	...
	dragonitedelivery: {
		...
		num: 149,
		types: ["Dragon","Flying"],
		abilities: {0: "Multiscale", 1: "Multiscale", H: "Multiscale"},
		baseStats: {
			hp: 91,
			atk: 159,
			def: 120,
	...
	chienpaomega: {
		...
		num: 1002,
		types: ["Dark","Ice"],
		abilities: {0: "Sword Of Damnation", 1: "Sword Of Damnation", H: "Sword Of Damnation"},
		baseStats: {
			hp: 80,
			atk: 160,
			def: 100,
	...
	dracovishmega: {
		...
		num: 882,
		types: ["Water","Dragon"],
		abilities: {0: "Jaws Of Carnage", 1: "Swift Swim", H: "Tidal Rush"},
		baseStats: {
			hp: 90,
			atk: 110,
			def: 110,
	...
	ironheart: {
		...
		num: 1066,
		types: ["Steel","Bug"],
		abilities: {0: "Parry", 1: "Iron Fist", H: "Mold Breaker"},
		baseStats: {
			hp: 78,
			atk: 122,
			def: 92,
	...
	snorlaxprimal: {
		...
		num: 143,
		types: ["Normal"],
		abilities: {0: "Inversion", 1: "Inversion", H: "Inversion"},
		baseStats: {
			hp: 160,
			atk: 130,
			def: 120,
	...
	victiniprimal: {
		...
		num: 494,
		types: ["Psychic","Fire"],
		abilities: {0: "Lucky Halo", 1: "Lucky Halo", H: "Lucky Halo"},
		baseStats: {
			hp: 100,
			atk: 140,
			def: 100,
	...
	abomasnowsanta: {
		...
		num: 460,
		types: ["Grass","Ice"],
		abilities: {0: "Christmas Spirit", 1: "Christmas Spirit", H: "Christmas Spirit"},
		baseStats: {
			hp: 90,
			atk: 142,
			def: 105,
	...
	bewearangry: {
		...
		num: 760,
		types: ["Normal","Fighting"],
		abilities: {0: "Blind Rage", 1: "Blind Rage", H: "Blind Rage"},
		baseStats: {
			hp: 120,
			atk: 135,
			def: 100,
	...
	darkrainightmare: {
		...
		num: 491,
		types: ["Dark"],
		abilities: {0: "Bad Dreams", 1: "Bad Dreams", H: "Bad Dreams"},
		baseStats: {
			hp: 70,
			atk: 110,
			def: 95,
	...
	solrocksystem: {
		...
		num: 338,
		types: ["Rock","Psychic"],
		abilities: {0: "Phantom", 1: "Fearmonger", H: "Mystic Power"},
		baseStats: {
			hp: 90,
			atk: 125,
			def: 115,
	...
	spectriercloud: {
		...
		num: 897,
		types: ["Flying"],
		abilities: {0: "Adrenaline Rush", 1: "Adrenaline Rush", H: "Adrenaline Rush"},
		baseStats: {
			hp: 100,
			atk: 80,
			def: 80,
	...
	calyrexcloudrider: {
		...
		num: 898,
		types: ["Psychic","Flying"],
		abilities: {0: "Breezy Neigh", 1: "Breezy Neigh", H: "Breezy Neigh"},
		baseStats: {
			hp: 100,
			atk: 100,
			def: 100,
	...
	wigglytuffapex: {
		...
		num: 40,
		types: ["Normal","Fairy"],
		abilities: {0: "Friend Guard", 1: "Competitive", H: "Magic Guard"},
		baseStats: {
			hp: 120,
			atk: 70,
			def: 55,
	...
	yveltalmega: {
		...
		num: 717,
		types: ["Dark","Flying"],
		abilities: {0: "Dark Aura", 1: "Dark Aura", H: "Dark Aura"},
		baseStats: {
			hp: 126,
			atk: 151,
			def: 105,
	...
	kartanafallen: {
		...
		num: 798,
		types: ["Grass","Steel"],
		abilities: {0: "Pinnacle Blade", 1: "Pinnacle Blade", H: "Pinnacle Blade"},
		baseStats: {
			hp: 159,
			atk: 181,
			def: 149,
	...
	tinkatonmega: {
		...
		num: 959,
		types: ["Fairy","Steel"],
		abilities: {0: "Demolitionist", 1: "Demolitionist", H: "Demolitionist"},
		baseStats: {
			hp: 85,
			atk: 110,
			def: 107,
	...
	mimikyuapex: {
		...
		num: 778,
		types: ["Ghost","Fairy"],
		abilities: {0: "Predator", 1: "Guilt Trip", H: "Opportunist"},
		baseStats: {
			hp: 79,
			atk: 90,
			def: 80,
	...
	kilozuna: {
		...
		num: 1079,
		types: ["Fire","Steel"],
		abilities: {0: "Ancient Idol", 1: "Stamina", H: "Pressure"},
		baseStats: {
			hp: 105,
			atk: 90,
			def: 135,
	...
	fogging: {
		...
		num: 1080,
		types: ["Water","Flying"],
		abilities: {0: "Drizzle", 1: "Neutralizing Fog", H: "Wind Rider"},
		baseStats: {
			hp: 60,
			atk: 45,
			def: 55,
	...
	breezing: {
		...
		num: 1081,
		types: ["Water","Flying"],
		abilities: {0: "Lightning Rod", 1: "Neutralizing Fog", H: "Water Compaction"},
		baseStats: {
			hp: 120,
			atk: 70,
			def: 60,
	...
	storming: {
		...
		num: 1082,
		types: ["Water","Flying"],
		abilities: {0: "Overcharge", 1: "Neutralizing Fog", H: "Storm Drain"},
		baseStats: {
			hp: 135,
			atk: 70,
			def: 65,
	...
	merrykarp: {
		...
		num: 1083,
		types: ["Fire","Fairy"],
		abilities: {0: "Blaze", 1: "Soundproof", H: "Wind Rider"},
		baseStats: {
			hp: 40,
			atk: 15,
			def: 15,
	...
	gyarevalry: {
		...
		num: 1084,
		types: ["Fire","Dragon"],
		abilities: {0: "Dancer", 1: "Soundproof", H: "Hospitality"},
		baseStats: {
			hp: 110,
			atk: 60,
			def: 70,
	...
	raichumegax: {
		...
		num: 26,
		types: ["Electric","Fighting"],
		abilities: {0: "Electro Booster", 1: "Electro Booster", H: "Electro Booster"},
		baseStats: {
			hp: 60,
			atk: 135,
			def: 95,
	...
	chimechomega: {
		...
		num: 358,
		types: ["Psychic","Steel"],
		abilities: {0: "Wind Chimes", 1: "Wind Chimes", H: "Wind Chimes"},
		baseStats: {
			hp: 85,
			atk: 50,
			def: 110,
	...
	absolmegaz: {
		...
		num: 359,
		types: ["Dark","Ghost"],
		abilities: {0: "Reaper's Embarce", 1: "Reaper's Embarce", H: "Reaper's Embarce"},
		baseStats: {
			hp: 65,
			atk: 154,
			def: 75,
	...
	staraptormega: {
		...
		num: 398,
		types: ["Fighting","Flying"],
		abilities: {0: "Brute Force", 1: "Giant Wings", H: "Blur"},
		baseStats: {
			hp: 85,
			atk: 140,
			def: 100,
	...
	garchompmegaz: {
		...
		num: 445,
		types: ["Dragon"],
		abilities: {0: "Sinister Claws", 1: "Sinister Claws", H: "Sinister Claws"},
		baseStats: {
			hp: 108,
			atk: 130,
			def: 85,
	...
	golurkmega: {
		...
		num: 623,
		types: ["Ground","Ghost"],
		abilities: {0: "Unstable Core", 1: "Unstable Core", H: "Unstable Core"},
		baseStats: {
			hp: 89,
			atk: 169,
			def: 115,
	...
	meowsticmega: {
		...
		num: 678,
		types: ["Psychic"],
		abilities: {0: "Prankster", 1: "Sheer Force", H: "Hyper Aggressive"},
		baseStats: {
			hp: 84,
			atk: 48,
			def: 89,
	...
	golisopodmega: {
		...
		num: 768,
		types: ["Bug","Steel"],
		abilities: {0: "Droideka", 1: "Droideka", H: "Droideka"},
		baseStats: {
			hp: 75,
			atk: 150,
			def: 175,
	...
	scovillainmega: {
		...
		num: 952,
		types: ["Grass","Fire"],
		abilities: {0: "Flaming Jaws", 1: "Sun Basking", H: "Big Leaves"},
		baseStats: {
			hp: 65,
			atk: 138,
			def: 85,
	...
	glimmoramega: {
		...
		num: 970,
		types: ["Rock","Poison"],
		abilities: {0: "Corrosion", 1: "Toxic Surge", H: "Lightning Rod"},
		baseStats: {
			hp: 83,
			atk: 90,
			def: 105,
	...
	tatsugirimega: {
		...
		num: 978,
		types: ["Dragon","Water"],
		abilities: {0: "Commander", 1: "Reservoir", H: "Tactical Retreat"},
		baseStats: {
			hp: 68,
			atk: 65,
			def: 90,
	...
	baxcaliburmega: {
		...
		num: 998,
		types: ["Dragon","Ice"],
		abilities: {0: "Permafrost", 1: "Snow Warning", H: "Keen Edge"},
		baseStats: {
			hp: 115,
			atk: 175,
			def: 105,
	...
	slate: {
		...
		num: 1222,
		types: ["Normal"],
		abilities: {0: "Perfectionist", 1: "Pickup", H: "Skill Link"},
		baseStats: {
			hp: 85,
			atk: 110,
			def: 65,
	...
	// 	types: ["Ghost", "Dark"],
	// 	genderRatio: {M: 0.5, F: 0.5},
	// 	baseStats: {hp: 73, atk: 64, def: 69, spa: 142, spd: 90, spe: 109},
	...
	// 	abilities: {0: "Mountaineer",  H: "Parental Bond"},
	// 	heightm: 8.4,
	// 	weightkg: 1032,
	// 	color: "Green",
	...
	exeggutorredux: {
		...
		types: ["Grass", "Normal"],
		genderRatio: {M: 0.5, F: 0.5},
		baseStats: {hp: 100, atk: 60, def: 105, spa: 130, spd: 105, spe: 30},
		abilities: {0: "Trigle", 1: "Stamina"},
		heightm: 2.1,
		weightkg: 120,
		color: "Yellow",
		eggGroups: ["Grass"],
