...
const Moves = {
  ...
  drumroll: {
    ...
    onHit(target, source, effect) {
      const moves = this.dex.moves.all().filter((move) => (![2, 4].includes(this.gen) || !source.moves.includes(move.id)) && !move.realMove && !move.isZ && !move.isMax && (!move.isNonstandard || move.isNonstandard === "Unobtainable") && move.basePower > 109 && move.id !== "drumrollcap");
      let randomMove = "";
      if (moves.length) {
