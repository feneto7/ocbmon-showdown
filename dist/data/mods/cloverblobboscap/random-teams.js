...
__export(random_teams_exports, {
  RandomBlobbosTeams: () => RandomBlobbosTeams,
...
class RandomBlobbosTeams extends import_random_teams.default {
  ...
  randomBlobbosMetronomeTeam() {
    ...
    const blobbosFormes = this.dex.species.all().filter((species) => species.baseSpecies === "Blobbos" && !species.battleOnly && species.name !== "Blobbos");
...
var random_teams_default = RandomBlobbosTeams;
