...
const Scripts = {
  ...
  pokemon: {
    ...
    ignoringAbility() {
      ...
      return !!(this.battle.gen >= 5 && !this.isActive || (this.volatiles["gastroacid"] || this.volatiles["sterilized"] || this.volatiles["shatteredampoule"] || neutralizinggas && (this.ability !== "neutralizinggas" || this.m.abils?.includes("ability:neutralizinggas"))) && !this.getAbility().isPermanent);
    }
  }
};
