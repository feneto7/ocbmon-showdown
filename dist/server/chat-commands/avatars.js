...
__export(avatars_exports, {
  Avatars: () => Avatars,
  OFFICIAL_CLODOWN_AVATARS: () => OFFICIAL_CLODOWN_AVATARS,
  commands: () => commands
});
...
const AVATAR_FORMATS_MESSAGE = Config.serverid === "clodown" ? "Custom avatars start with '#', like '#splxraiders'." : "Custom avatars look like 'example.png'. Custom avatars should be put in `config/avatars/`. Your server must be registered for custom avatars to work.";
...
const OFFICIAL_CLODOWN_AVATARS = /* @__PURE__ */ new Set([
  "clover-kymmibattle",
  "clover-stump",
  "clover-kymmi",
  "clover-rocker",
  ...
  "wack-zaydolf2",
  "wack-zaydolffuhrer",
  "wack-zaydolf-resprite",
  "wack-zaydolf2-resprite",
  "wack-zaydolf3-resprite",
  "wack-zaydolffuhrer-resprite",
  "wack-anne",
  "wack-anne2",
  "wack-anne-resprite",
  "wack-anne2-resprite",
  ...
  "wack-lomar-resprite",
  "wack-claire",
  "wack-claire-resprite",
  "wack-vlad",
  "wack-vlad-resprite",
  "wack-duette",
  "wack-duette-resprite",
  "wack-jeevestobs",
  "wack-jeevestobs-resprite",
  "wack-hiroshima",
  "wack-hiroshima-resprite",
  "wack-merlin",
  "wack-wackgruntm",
  "wack-wackgruntf",
  "wack-wackgruntm-resprite",
  "wack-wackgruntf-resprite",
  "wack-twaquaforcem-resprite",
  "wack-twaquaforcef-resprite",
  "wack-eva",
  "wack-zyklon",
  "wack-zyklon-resprite",
  "wack-manglo",
  "wack-shlomo",
  "wack-shlomo-resprite",
  "wack-silverman",
  "wack-silverman-resprite",
  "wack-goldberg",
  "wack-goldberg-resprite",
  "wack-vira",
  "wack-vira-resprite",
  "wack-cybrus",
  "wack-cybrus-resprite",
  "wack-stella",
...
for (const avatar of OFFICIAL_AVATARS_FIFTY)
  OFFICIAL_AVATARS.add(avatar);
for (const avatar of OFFICIAL_CLODOWN_AVATARS)
  OFFICIAL_AVATARS.add(avatar);
const commands = {
