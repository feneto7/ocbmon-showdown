...
var import_discord = require("./discord");
...
const Chat = new class {
  constructor() {
    ...
    this.Badges = new import_badges.BadgesDatabase();
    this.Discord = new import_discord.DiscordClient();
  ...
  getDataPokemonHTML(species, gen = 8, tier = "") {
    ...
    if (species.types) {
      for (const type of species.types) {
        ...
        buf += `<img src="//${Config.routes.client}/sprites/types/${encodedType}.png" alt="${type}" height="14" width="32">`;
      }
    }
    buf += "</span> ";
    if (gen >= 3) {
