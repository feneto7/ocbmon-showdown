...
const TEXT_DATA_TYPES = ["Abilities", "Default", "Items", "Moves", "Pokedex"];
const DATA_FILES = {
  Abilities: "abilities",
  Aliases: "aliases",
  Rulesets: "rulesets",
  ...
  loadTextData() {
    ...
    if (parentDex) {
      ...
      for (const dataType of TEXT_DATA_TYPES) {
        const parentText = parentTextTable[dataType];
        const childText = textCache[dataType] || (textCache[dataType] = {});
