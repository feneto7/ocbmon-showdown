  ...
  */
  ...
  ignoringAbility() {
    ...
    if (this.volatiles["gastroacid"])
      return true;
    if (this.volatiles["sterilized"] || this.volatiles["shatteredampoule"])
      return true;
    ...
    if (this.hasItem("Ability Shield") || this.ability === "hellishvoid")
      return false;
    for (const pokemon of this.battle.getAllActive()) {
      if (pokemon.ability === "hellishvoid" && !pokemon.volatiles["gastroacid"] && !pokemon.transformed && !pokemon.abilityState.ending && !this.volatiles["commanding"]) {
        return true;
      }
    }
    return false;
